...
/* ── Caregiver Status Helper ─────────────────────────────────────── */
function mapCaregiverStatus(status) {
  switch (status) {
    case "verified_present":
      return { label: "Caregiver Present", color: "#00FF9D", bg: "rgba(0, 255, 157, 0.12)", border: "rgba(0, 255, 157, 0.35)" };
    case "warning":
      return { label: "Caregiver Warning", color: "#FFB800", bg: "rgba(255, 184, 0, 0.12)", border: "rgba(255, 184, 0, 0.35)" };
    case "missing":
      return { label: "Caregiver Missing", color: "#FF8C00", bg: "rgba(255, 140, 0, 0.15)", border: "rgba(255, 140, 0, 0.4)" };
    case "missing_critical":
      return { label: "CRITICAL — Caregiver Absent!", color: "#FF3B5C", bg: "rgba(255, 59, 92, 0.18)", border: "rgba(255, 59, 92, 0.5)" };
    default:
      return { label: "Awaiting Caregiver Data…", color: "#94A3B8", bg: "rgba(148, 163, 184, 0.08)", border: "rgba(148, 163, 184, 0.2)" };
  }
}
...
export default function TrackingDashboard() {
  ...
  // ── Caregiver Identification & Continuity State ──
  ...
  // Telemetry updates from TrackingFeed
  ...
  return (
    <>
      ...
      <div className="dashboard">
        ...
        {/* Critical Caregiver Absence Alert */}
        {isCaregiverCritical && (
          <div
            style={{
              marginBottom: "1rem",
        ...
        <div className="main-grid">
          ...
          <div className="alerts-column">
            {/* Caregiver Recognition & Continuity Status Panel */}
